...
public class TypeErrorTests extends DynamicTestSuite {
	private final static String DIRECTORY_PATH = "type_errors/";
	
	public TypeErrorTests(String filename) { super(filename); }
