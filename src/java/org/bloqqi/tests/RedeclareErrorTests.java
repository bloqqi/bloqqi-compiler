...
public class RedeclareErrorTests extends DynamicTestSuite {
	private final static String DIRECTORY_PATH = "redeclare_errors/";
	
	public RedeclareErrorTests(String filename) { super(filename); }
