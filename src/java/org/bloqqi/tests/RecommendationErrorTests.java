...
public class RecommendationErrorTests extends DynamicTestSuite {
	private final static String DIRECTORY_PATH = "recommendation_errors/";
	
	public RecommendationErrorTests(String filename) { super(filename); }
