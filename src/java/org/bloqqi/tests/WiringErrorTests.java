...
public class WiringErrorTests extends DynamicTestSuite {
	private final static String DIRECTORY_PATH = "wiring_errors/";
	
	public WiringErrorTests(String filename) { super(filename); }
