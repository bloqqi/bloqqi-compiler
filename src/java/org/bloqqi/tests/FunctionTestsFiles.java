...
public class FunctionTestsFiles extends DynamicTestSuite {
	private final static String DIRECTORY_PATH = "function_errors/";
	
	public FunctionTestsFiles(String filename) { super(filename); }
